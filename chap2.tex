\chapter{Speed and Angle Estimation (Sprint 1)}
...
The chapter begins with an overview of the state-of-the-art methods for speed and angle estimation in computer vision, followed by a detailed description of the implemented pipeline architecture. Mathematical foundations are then established, covering the core computations and smoothing algorithms. Implementation challenges encountered during development are discussed, along with the configuration parameters that govern the system's behavior.

\section{State of the Art in Speed Estimation}
\label{sec:sota-speed}
...
\subsection{Homography-Based Methods}
...
\subsection{Optical Flow Methods}
...
\section{State of the Art in Angle and Heading Estimation}
\label{sec:sota-angle}

\subsection{Trajectory-Based Methods}
...
\subsection{Curvature-Based Methods}
...
\subsection{Angular Rate Integration}
...
\section{Implemented Pipeline Architecture}
\label{sec:pipeline}
...
\subsection{Trajectory Dot System}
...
\subsection{Sparse Trajectory Dots}
...
\subsection{Zero Velocity False Positives}
...
\subsection{Heading Uncertainty at Low Speeds}
